...
def track_package(tracking_number):
  """  «»"Rastrea un paquete utilizando el sitio web de ZIM y devuelve los detalles de seguimiento.

  Args:
      tracking_number (str): El número de seguimiento del paquete.

  Devuelve:
      lista: Una lista de cadenas que contiene los detalles de seguimiento, o una lista vacía si hay un error.
  «»»
  """
  ...
  if not chromedriver_path:
    raise ValueError("CHROMEDRIVER_PATH environment variable not set!")
  ...
  try:
    ...
    # Use explicit waits with specific conditions for improved reliability
